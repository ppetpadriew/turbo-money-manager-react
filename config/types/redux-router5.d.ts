...
declare module "redux-router5/lib/actionTypes" {
  export const NAVIGATE_TO:string;
  export const CANCEL_TRANSITION:string;
  export const TRANSITION_ERROR:string;
  export const TRANSITION_SUCCESS:string;
  export const TRANSITION_START:string;
  export const CLEAR_ERRORS:string;
}
